      ...
      >
        ...
        {isMobile && (
          <div className="w-full lg:w-1/2 max-w-md lg:max-w-lg flex flex-col items-center mb-8">
            <div className="bg-[#ff7300] rounded-xl p-4 sm:p-6 lg:p-8 w-full shadow-lg flex flex-col items-center mb-6 sm:mb-8">
              ...
              <div className="relative w-full max-w-xs sm:max-w-sm lg:max-w-md aspect-square">
                <Image
                  ...
                  width={400}
                  height={400}
                  className="absolute inset-0 w-full h-full object-contain opacity-20 rounded-lg"
                />
        ...
        <div className="fixed bottom-4 right-4 z-30">
          <a
            href="https://wa.me/5930998700860"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#25D366] hover:bg-[#1EBE57] text-white p-3 sm:p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 flex items-center gap-2 group"
