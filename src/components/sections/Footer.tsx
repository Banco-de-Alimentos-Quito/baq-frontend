    ...
    <footer className="w-screen bg-gray-800 text-gray-300 py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6 ">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-primary" /> Av. Maldonado y
                Saraguro, Quito
              </li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex space-x-4">
                ...
                <Link
                href="https://www.linkedin.com/company/banco-de-alimentos-quito"
                aria-label="LinkedIn"
                className="text-gray-400 hover:text-primary transition-colors flex items-center gap-2"
                >
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm">
          ...
          <p className="mt-1">
            Diseñado con{" "}
            <HeartHandshake className="inline h-4 w-4 text-primary " /> para
